...
export function defaultProps(theme: { spacing: (arg0: number) => any }) {
  return {
    MuiAlert: {
      defaultProps: {
        iconMapping: {
    ...
    MuiAutocomplete: {
      defaultProps: {
        popupIcon: <ArrowDownIcon component={"symbol"} />,
      },
    },
    MuiSelect: {
      defaultProps: {
    ...
    MuiRating: {
      defaultProps: {
        emptyIcon: <RatingIcon component={"symbol"} />,
        icon: <RatingIcon component={"symbol"} />,
      },
    },
    MuiTreeView: {
      defaultProps: {
        defaultCollapseIcon: <TreeViewCollapseIcon component={"symbol"} />,
        defaultExpandIcon: <TreeViewExpandIcon component={"symbol"} />,
        defaultEndIcon: <TreeViewEndIcon component={"symbol"} />,
      },
    },
  };
}
