...
export const IMAGE_KIT_PRIVATE_KEY = process.env.NEXT_PUBLIC_IMAGE_KIT_PRIVATE_KEY;
export const IMAGE_KIT_URL_ENDPOINT = process.env.NEXT_PUBLIC_IMAGE_KIT_URL_ENDPOINT;
