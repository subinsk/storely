...
export const varBgColor = (
  props: { colors: string[]; duration: number; ease: string } | undefined
) => {
...
export const varBgKenburns = (
  props: { duration: number; ease: string } | undefined
) => {
  const duration = props?.duration || 5;
...
export const varBgPan = (
  props: { duration: number; ease: string; colors: string[] } | undefined
) => {
